...
// MDSSpinnakerSDK.h: PROJECT_NAME 애플리케이션에 대한 주 헤더 파일입니다.
//
...
struct MDS_IRFormatArray
{
	static const TCHAR* MDS_IRFormatStrings[];
};
...
// CMDSSpinnakerSDKApp:
// 이 클래스의 구현에 대해서는 MDSSpinnakerSDK.cpp을(를) 참조하세요.
//

class CMDSSpinnakerSDKApp : public CWinApp
{
public:
	CMDSSpinnakerSDKApp();
...
extern CMDSSpinnakerSDKApp theApp;
